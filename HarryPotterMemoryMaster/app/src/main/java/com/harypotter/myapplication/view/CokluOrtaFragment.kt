...
import com.harypotter.myapplication.databinding.FragmentCokluOrtaBinding
...
class CokluOrtaFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        when(siraOyuncu){
            1->binding.textOyunSiraCO.text="1.Oyuncunun sırası"
            2->binding.textOyunSiraCO.text="2.Oyuncunun sırası"
        }
        ...
        binding.buttonNotDefterCO.setOnClickListener {
    ...
    private fun geriSayim() {
        sayici=object :CountDownTimer(60000,1000){
            override fun onTick(p0: Long) {
                binding.textViewSureTO.text="Süre: ${p0/1000}"
                kalanSure=p0/1000
            }
        ...
        if (cards[position1].identifier.kartIsim==cards[position2].identifier.kartIsim){
            ...
            when(siraOyuncu){
                1->{
                    ...
                    binding.textPuan1CO.text="1.Oyuncu: ${puan1.toInt()} puan"
                }
                2->{
                    //2. oyuncu puanEkle
                    val kartPuan=cards[position1].identifier.kartPuan
                    ...
                    binding.textPuan2CO.text="2.Oyuncu: ${puan2.toInt()} puan"
                }
            }
            //eşleşme müziği çal
            if (countMatch==8){
            ...
            when(siraOyuncu){
                1->{
                    siraOyuncu=2
                    binding.textOyunSiraCO.text="${siraOyuncu}.Oyuncunun sırası"
